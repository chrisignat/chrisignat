...
# 💫 About Me:
<p align="left">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=22&pause=1000&color=00ff00&width=550&lines=Building+Secure+Infrastructure;Exploring+AI+and+AIOps;Focusing+on+DevSecOps;Architecting+One-Click+Platforms" alt="Typing SVG" />
</p>

<br>
👨‍💻 Junior Platform Engineer with a passion for building secure, scalable, and automated environments.<br><br>🛡️ Focus Areas: Everything related to Networking, Security, and Scripting.<br><br>⚙️ Mission: I love building systems that empower teams—turning complex operations into simple "one-click" solutions to optimize workflows and boost productivity.<br><br>🌍 Philosophy: Huge advocate for Open Source – In code we trust.
...
- [x] **Learn By Doing: AWS Workshop with Terraform** ☁️

- [x] **Kubernetes Networking Deep Dive** 🕸️

- [x] **Ultimate Certified Kubernetes Administrator (CKA) Mock Exam** 📝

- [x] **Learn-By-Doing Kubernetes Network Policies** 🛡️

- [x] **Prep Course - Prometheus Certified Associate (PCA)** 📈

- [x] **Learn By Doing: AIOps Foundations** 🤖

- [x] **Terraform Associate Certification: HashiCorp** 🏗️

- [x] **Certified Kubernetes Administrator (CKA)** 🎖️
...
- [x] **Learn Ansible Basics – Beginners Course** ⚙️
